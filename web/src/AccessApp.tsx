...
export function AccessApp() {
  ...
  const mobileAccount = <button type="button" className="mobile-account-button" aria-label={`账户 ${state.user.email}`} onClick={() => undefined}>{state.user.email.slice(0, 1).toUpperCase()}</button>;
