...
export function CashLedgerPage() {
  ...
  const resetAndLoad = () => {
    ...
    setStatus("loading"); setErrorMessage(undefined); setAppendError(undefined); setAppendLoading(false); setFilterOptionsLoading(true); setItems([]); setNextCursor(null); setMonthlySummaries([]);
