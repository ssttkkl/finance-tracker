# PostgreSQL-Only Runtime Storage
...
## Source
完整迁移来源与原始验证证据：[001-postgres-only-storage/spec.md](../../changes/archive/2026-08-01-001-postgres-only-storage/legacy/001-postgres-only-storage/spec.md)。
