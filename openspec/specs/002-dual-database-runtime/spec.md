# PostgreSQL and SQLite Runtime Parity
...
## Source
完整迁移来源与原始验证证据：[002-dual-database-runtime/spec.md](../../changes/archive/2026-08-01-002-dual-database-runtime/legacy/002-dual-database-runtime/spec.md)。
