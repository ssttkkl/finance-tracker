# Row-Level Idempotent Import (Incremental)
...
## Source
完整迁移来源与原始验证证据：[010-row-idempotent-import/spec.md](../../changes/archive/2026-08-01-010-row-idempotent-import/legacy/010-row-idempotent-import/spec.md)。
