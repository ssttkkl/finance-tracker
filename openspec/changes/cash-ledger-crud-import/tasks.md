...
- **当前 HEAD**：`24e8f317435a481d83bb280c6e9905ef961c8f95`（已推送的 PR 分支 `codex/cash-ledger-crud-import`；本轮 change 尚有未提交文档与原型改动）。
