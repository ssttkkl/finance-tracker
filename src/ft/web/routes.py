...
def _cash_import_error(exc: ValueError) -> JSONResponse:
    ...
    messages = {
        ...
        "import_component_allocation_incomplete": "请补齐组合支付各组成项金额后再确认。",
        "import_component_amount_invalid": "组合支付组成项金额无效，请检查后重试。",
        "cash_transaction_components_in_use": "该流水的组成项已参与关联，修改金额或账户前请先解散关联。",
