...
SCHEMA_REVISION = "20260920_36"
REQUIRED_TABLES = {
    "workspaces", "accounts", "cash_transactions", "cash_transaction_components", "investment_events",
    "ledger_snapshots",
    ...
    "cash_categories", "cash_category_states", "statement_account_mappings", "cash_import_commits",
}
