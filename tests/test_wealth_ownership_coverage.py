...
def test_same_ticker_two_accounts_and_missing_owner_fail_closed(ownership_runtime, monkeypatch) -> None:
    ...
    with sessions.begin() as session:
        ...
        session.add(InvestmentEventModel(
            ...
            record_type="trade", record_subtype="security", currency="CNY", payload={"position": "ghost", "quantity": "1"},
        ))
    ...
    with sessions.begin() as session:
        ...
        session.add_all((
            ...
            InvestmentEventModel(
                ...
                record_type="trade", record_subtype="security", currency="CNY", payload={"position": "owned-etf", "quantity": "1"},
            ),
        ))
