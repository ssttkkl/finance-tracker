...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("icbc_credit", {"summary": "转账", "category": "income", "amount": Decimal("10")}, "transfer_in"),
        ("icbc_credit", {"summary": "转帐", "category": "income", "amount": Decimal("10")}, "transfer_in"),
        ("icbc_credit", {"summary": "转账", "category": "expense", "amount": Decimal("-10")}, "transfer_out"),
